...
typedef NS_ENUM(NSInteger, ZDTabItemBadgeStyle) {
    ZDTabItemBadgeStyleNumber = 0, // 数字样式
    ZDTabItemBadgeStyleDot = 1, // 圆点样式
};

/**
 多选框item
 */
@interface ZDTabItem : UIButton
/// 在父视图中的下标
...
/// badge类型 2种：数字，小圆点
@property (nonatomic, assign) ZDTabItemBadgeStyle badgeStyle;

/**
 * 如果badgeStyle == XHZDabItemBadgeStyleNumber时，可设置此属性，显示badge值
 * badge > 99, 显示99+
